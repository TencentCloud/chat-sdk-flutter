...
class TencentImSDKPluginWeb extends ImFlutterPlatform {
  ...
  static final V2TIMMessageManager _v2timMessageManager =
      V2TIMMessageManager(_v2timSignalingManager);
  ...
  Future<void> removeAdvancedMsgListener({String? listenerUuid}) async {
    _v2timMessageManager.removeAdvancedMsgListener(listenerUuid);
  }
  ...
  Future<void> removeGroupListener({
    ...
    return _v2timManager.removeGroupListener(listenerUuid);
  }
  ...
  Future<void> removeFriendListener({
    ...
    return _v2timFriendshipManager.removeFriendListener(listenerUuid);
  }
